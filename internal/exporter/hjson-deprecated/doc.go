...
// (see pkg/importer/hjson's doc comment and Konzept.md's "HJSON
...
//     pkg/importer/hjson's Emit doc comment).
...
//     pkg/sqlite/model_export.go); an owner with more attribute rows
